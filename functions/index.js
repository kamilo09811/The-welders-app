/**
 * Cloud Functions — Expo Push + alerty o nowych ogłoszeniach.
 *
 * Deploy: firebase deploy --only functions
 * Wymaga planu Blaze (api.expo.dev).
 */
...
/** Uproszczona lista miast PL (zgodna z lib/pl-cities.ts). */
const PL_CITIES = [
...
/** Nowe ogłoszenie → in-app dla użytkowników z notifNewJobs (i dopasowaną rolą / lokalizacją). */
